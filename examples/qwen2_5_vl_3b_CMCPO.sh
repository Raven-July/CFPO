...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_CMCPO_ref_noentropy_highthres_fixed \
    ...
    trainer.save_checkpoint_path=${BASE_PATH}/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_3b_CMCPO_ref_noentropy_highthres_fixed \
