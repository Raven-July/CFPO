...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_CFPO-G-math-bs384_V3_ref_noentropy \
    ...
    trainer.save_checkpoint_path=/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_3b_CFPO-G-math-bs384_V3_ref_noentropy \
