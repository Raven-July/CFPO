...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_CMCPO-math-bs384_V3_ref_noentropy \
    ...
    trainer.save_checkpoint_path=${BASE_PATH}/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_3b_CMCPO-math-bs384_V3_ref_noentropy \
