...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_CMCPO-D-math-bs384_V3_noref_orientropy_lowcoef \
    ...
    trainer.save_checkpoint_path=${BASE_PATH}/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_3b_CMCPO-D-math-bs384_V3_noref_orientropy_lowcoef \
