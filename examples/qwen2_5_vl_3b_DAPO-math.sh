...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_3b_DAPO-math-bs384 \
    ...
    trainer.save_checkpoint_path=/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_3b_DAPO-math-bs384 \
