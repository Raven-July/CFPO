...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Evaluate VLM models on specified datasets.")
...
def main():
    ...
    if args.dataset_name == 'C-VQA-Real':
        ...
        DATA_ROOT = "eval_data"
        IMAGE_ROOT = "/home/sunwanran/dataset/C-VQA/C-VQA-Synthetic/C-VQA-Synthetic_images"
    ...
    if 'qwen2.5-vl-3b' in args.model_name.lower():
    ...
    if rank == 0:
        ...
        for i, (input_example, model_answer_raw) in enumerate(zip(data, all_outputs)):
            ...
            if args.dataset_name == 'C-VQA-Real' or args.dataset_name == 'C-VQA-Synthetic':
        ...
        # --- 动态生成输出文件名并保存 ---
        output_filename = f"results_{args.model_name}_{args.dataset_name}.json"
