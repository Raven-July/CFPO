...
# --- 全局配置 ---
OUTPUT_DIR=${BASE_PATH}/Counterfact-Projects/Counterfactual-R1/Counterfactual-Eval/eval_result_math_7b_8

MODEL_NAME=Qwen2.5-VL-7B
MODEL_PREFIX="CMCPO-D-orientropy-lowcoef-math-202"
# MODEL_PREFIX="PAPO-D"
...
MODEL_PATH=${BASE_PATH}/Counterfact-Projects/Counterfactual-R1/checkpoints/qwen2_5_vl_7b_CMCPO-D-math-bs384_V3_noref_orientropy_lowcoef/global_step_202/actor/huggingface
